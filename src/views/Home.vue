<template>
  <main class="home-main">
    ...
    <section id="categories" class="section section--marquee">
      <CategoriesSection />
    </section>
    ...
    <section id="portafolio" class="section section--flush">
      <ProductStore />
    </section>
...
/* Franja azul del marquee: mismo fondo, sin huecos */
.section--marquee {
...
.section--marquee :deep(.marquee-band) {
  margin: 0;
}
